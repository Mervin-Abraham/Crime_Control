...
class Facerecongnotion : AppCompatActivity() {
            ...
            if ( grantResults[ 0 ] == PackageManager.PERMISSION_GRANTED ) {
                ...
                val alertDialog = AlertDialog.Builder( this ).apply {
                    ...
                    setPositiveButton( "ALLOW" ) { dialog, which ->
                        dialog.dismiss()
                        ActivityCompat.requestPermissions( context as Facerecongnotion,
        ...
        if ( requestCode == REQUEST_DIRECTORY_ACCESS && resultCode == RESULT_OK) {
            ...
            if ( !errorFound ) {
                ...
                val alertDialog = AlertDialog.Builder( this ).apply {
                    ...
                    setMessage( "There were some errors while parsing the directory. RETRY!!" )
                    setCancelable( false )
